...
/**
 * Class allows the user that is player two to place their ships before the start of the game.
 */
public class PlayerTwoPlaceShips extends AppCompatActivity {
    ...
    private DatabaseReference playerTwoBoardReference = database.getReference("playerTwoBoard");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_two_place_ships);
        ...
        startMovesCntReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (nextActivityCnt == 2) {
                    Intent intent = new Intent(PlayerTwoPlaceShips.this, PlayerTwoMoves.class);
        ...
        playerSignedOutReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (onePlayerSignedOut) {
                    ...
                    Intent intent = new Intent(PlayerTwoPlaceShips.this, AuthenticationActivity.class);
                    startActivity(intent);
                }
            }
    ...
    public void addToFirebase() {
        ...
        playerTwoBoardReference.setValue(nestedBooleanList);
        Toast.makeText(getApplicationContext(), "You, Player2, have placed your ships", Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        AuthUI.getInstance().signOut(PlayerTwoPlaceShips.this);
