...
public class PlayerOneMoves extends AppCompatActivity {

    private FirebaseDatabase database = FirebaseDatabase.getInstance();

    //The reason I changed the suffix from Reference to Ref is because the names were long enough already.
    private DatabaseReference playerOneBoardRowOneRef = database.getReference("playerTwoBoard/0");
    private DatabaseReference playerOneBoardRowTwoRef = database.getReference("playerTwoBoard/1");
    private DatabaseReference playerOneBoardRowThreeRef = database.getReference("playerTwoBoard/2");
    private DatabaseReference playerOneBoardRowFourRef = database.getReference("playerTwoBoard/3");
    private DatabaseReference playerOneBoardRowFiveRef = database.getReference("playerTwoBoard/4");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerOneBoardRowOneRef.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        playerOneBoardRowTwoRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                GenericTypeIndicator<List<Boolean>> genericTypeIndicator = new GenericTypeIndicator<List<Boolean>>() {
                };
        ...
        playerOneBoardRowThreeRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                GenericTypeIndicator<List<Boolean>> genericTypeIndicator = new GenericTypeIndicator<List<Boolean>>() {
                };
        ...
        playerOneBoardRowFourRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                GenericTypeIndicator<List<Boolean>> genericTypeIndicator = new GenericTypeIndicator<List<Boolean>>() {
                };
        ...
        playerOneBoardRowFiveRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                GenericTypeIndicator<List<Boolean>> genericTypeIndicator = new GenericTypeIndicator<List<Boolean>>() {
                };
        ...
        gameFinishedReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (gameFinished) {
                    Intent intent;
                    if (hitCnt == 9) {
                        intent = new Intent(PlayerOneMoves.this, WinnerActivity.class);
                    } else {
                        intent = new Intent(PlayerOneMoves.this, LoserActivity.class);
                    }
        ...
        playerSignedOutReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (onePlayerSignedOut) {
                    ...
                    Intent intent = new Intent(PlayerOneMoves.this, AuthenticationActivity.class);
                    startActivity(intent);
                }
            }
        ...
        playerTwoFiveAwayReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                boolean playerTwoFiveAway = dataSnapshot.getValue(Boolean.class);
                if (playerTwoFiveAway) {
                    createNotificationFiveAway();
                    playerTwoFiveAwayReference.setValue(FALSE);
                }
            }
        ...
        playerTwoOneAwayReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                boolean playerTwoOneAway = dataSnapshot.getValue(Boolean.class);
                if (playerTwoOneAway) {
                    createNotificationOneAway();
                    playerTwoOneAwayReference.setValue(FALSE);
                }
     ...
     */
    public void createNotificationPlayerOne() {
     ...
     *
     * @return PendingIntent - intent of the next Activity.
     */
    ...
    public void onClickListenerWork(int rowIndex, int columnIndex, TextView box) {
        ...
        if (booleanBoard[rowIndex][columnIndex]) {
            ...
            if (hitCnt == 9) {
                ...
                playerOneFiveAwayReference.setValue(TRUE);
            } else if (hitCnt == 8) {
                playerOneOneAwayReference.setValue(TRUE);
            }
        } else {
        ...
        turnTrackerReference.setValue(TRUE);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        AuthUI.getInstance().signOut(PlayerOneMoves.this);
